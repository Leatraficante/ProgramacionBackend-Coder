...
export default class ProductRouter extends Router {
  ...
  init() {
    ...
    this.post('/', [accessRolesEnum.USER, accessRolesEnum.ADMIN], passportStrategiesEnum.JWT, saveProduct);
    this.put('/:pid', [accessRolesEnum.USER, accessRolesEnum.ADMIN], passportStrategiesEnum.JWT, updateProduct);
    this.delete('/:pid', [accessRolesEnum.USER, accessRolesEnum.ADMIN], passportStrategiesEnum.JWT, deleteProduct);
  };
};
