...
export default class Router {
    ...
    // Supongamos que ya has importado accessRolesEnum y passportStrategiesEnum
    ...
    handlePolicies = (policies) => (req, res, next) => {
        try {
            ...
            if (!policies.includes(user.role.toUpperCase()) && user.role.toUpperCase() !== accessRolesEnum.ADMIN) {
