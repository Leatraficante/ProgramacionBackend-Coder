...
export default class CartRouter extends Router {
  ...
  init() {
    ...
    this.post('/', [accessRolesEnum.USER, accessRolesEnum.ADMIN], passportStrategiesEnum.JWT, saveCart);
    ...
    this.get('/purchase/:cid', [accessRolesEnum.USER], passportStrategiesEnum.JWT, purchase);
  };
};
